 ...
 * <p>
 * IndividualCustomerViewController implements the controls of the individual customers view.
 *
 */
public class IndividualCustomerViewController extends GenericEntityTableViewController<Customer> {

	@FXML
	private AnchorPane FXID_IndividualCustomersView;
	...
	public void buildView() {
		...
		super.buildView( EntityProperties.get( IndividualCustomer.class ), "Customer", new ContextMenuItemsDescriptor[] {
			//
	...
	public int refreshView() {
		...
		FilteredList<Customer> filteredList = new FilteredList<Customer>( oList, s -> {
			return s instanceof IndividualCustomer;
		} );
	...
	@FXML
	void createAction() {
		entryDialog( businessLogicImpl.newIndividualCustomer(), eps, true, this );
	}
